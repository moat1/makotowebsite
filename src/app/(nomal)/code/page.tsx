export default function Code() {
  return (
    <main className="m-auto px-20 text-gray-800 max-sm:px-5">
      <h1 className="flex justify-center p-3 text-3xl font-bold text-black">利用規約</h1>
      <div className="p-10 max-sm:px-5">
        ...
        <ul className="mb-2 ml-5">
          ...
          <li className="mb-2">2. 犯罪行為に関連する行為</li>
          <li className="mb-2">
            3.
          ...
          <li className="mb-2">6. 当サイトのサービスの運営を妨害するおそれのある行為</li>
          <li className="mb-2">7. 不正アクセスをし，またはこれを試みる行為</li>
          <li className="mb-2">
            8. 他のユーザーに関する個人情報等を収集または蓄積する行為
          </li>
          <li className="mb-2">9. 不正な目的を持って本サービスを利用する行為</li>
          <li className="mb-2">
            10.
            本サービスの他のユーザーまたはその他の第三者に不利益，損害，不快感を与える行為
          </li>
          <li className="mb-2">
            11. 当サイトが許諾しない本サービス上での宣伝，広告，勧誘，または営業行為
          </li>
          <li className="mb-2">
            12.
        ...
        <ul className="mb-2 ml-5">
          ...
          <ul className="mb-2 ml-5">
            <li className="mb-2">1. 本規約のいずれかの条項に違反した場合</li>
            <li className="mb-2">
              2. その他，当サイトが本サービスの利用を適当でないと判断した場合
            </li>
          </ul>
          <li className="mb-2">
            2.
